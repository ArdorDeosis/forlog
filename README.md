...
*This introduction soon can also be found at* [forlog.firespark.de](http://forlog.firespark.de/)*(still WIP), accompanied by an online processor with graphical user interface and working examples (and hopefully soon with syntax highlighting).*
